...
#  ARGOS_LIBRARY_DIR - The link directory of the ARGoS libraries
#
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(ARGoS DEFAULT_MSG ARGOS_LIBRARY_DIR ARGOS_INCLUDE_DIR)

IF(ARGOS_INCLUDE_DIR AND ARGOS_LIBRARY_DIR)
  SET(ARGOS_INCLUDE_DIRS )
  SET(ARGOS_LIBRARY_DIRS	 )
ENDIF(ARGOS_INCLUDE_DIR AND ARGOS_LIBRARY_DIR)

MARK_AS_ADVANCED(ARGOS_INCLUDE_DIR)
MARK_AS_ADVANCED(ARGOS_LIBRARY_DIR)
